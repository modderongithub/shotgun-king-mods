...
CARDS={
	...
	{ gid=68, id="Scouting",					sac=1, gain={0,0,0} },	
	...
	{ gid=73,	id="Theocracy",					sac=5, gain=2, need={2,2}, bishop_hp=2, theocracy=1, },
	{ gid=75,	id="Iron Maiden",				need=4, queen_iron=1, },	
	{ gid=76,	id="Court of the King",	n=2, gain={1,1,2,3}  },
	{ gid=77,	id="The Red Book",			gain=2, bishop_orth=1  },
	
	{ gid=78,	id="Saboteur",					n=2, sac={0,0}, gain=2, bad_shells=1  },	
	{ gid=80,	id="Lookout Tower",			n=2, gain=3, delay=15, alarm=5 },	
	{ gid=81,	id="Throne Room",				n=1, king_hp=2, queen_hp=1 },
	{ gid=82,	id="The Secret Heir",		gain=0, heir=1 },
	{ gid=83,	id="Crossdresser",			sac=2, gain=4, delay=10 },
...
PIECES={
	{type=0, name="pawn", 		hp=3, tempo=1, seek="wdist" },
	{type=1, name="knight", 	hp=3, tempo=1, seek="kdist" },
	{type=2, name="bishop", 	hp=4, tempo=1, seek="bdist" },
	{type=3, name="rook", 		hp=5, tempo=1, seek="rdist" },
	{type=4, name="queen", 		hp=5, tempo=1, seek="qdist" },
	{type=5, name="king", 		hp=8, tempo=1, seek="wdist" },
	{type=6, name="boss", 		hp=24, tempo=1, big=true, seek="wdist" },
	{type=7, name="all", 		 	}, 
	{type=8, name="leader", 	},
}
